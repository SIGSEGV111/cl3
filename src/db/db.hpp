	...
	namespace	db
	{
		...
		class	CL3PUBT	TResultSet : public virtual io::collection::IStaticIterator<const TRow>
		{
			...
			public:
				...
				CL3PUBF	bool	FindNext	(const io::collection::IMatcher<TRow>& matcher) final override;
				CL3PUBF	bool	FindPrev	(const io::collection::IMatcher<TRow>& matcher) final override;
